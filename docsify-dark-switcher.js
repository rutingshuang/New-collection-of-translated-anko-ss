...
.docsify-dark-mode .content {
    background: var(--dark-base-background) !important;
}

.docsify-dark-mode .markdown-section {
    background: var(--dark-base-background);
}
...
.docsify-dark-mode html,
.docsify-dark-mode body,
.docsify-dark-mode #app,
.docsify-dark-mode .app,
.docsify-dark-mode main,
.docsify-dark-mode .content,
.docsify-dark-mode .content article,
.docsify-dark-mode .markdown-section {
    background: var(--dark-base-background) !important;
}
`;
